...
namespace NathanUpload
{
	...
	public class ListViewEx : ListView
	{
      ...
      public string Name;
		...
		private ArrayList _embeddedControls = new ArrayList();  //Holds all the embedded controls (Progress bars)

    public void removeAllControls()
        {
            this._embeddedControls.Clear();
            this.Controls.Clear();
        }
		...
		public ListViewEx()
    {
		...
		protected Rectangle GetSubItemBounds(ListViewItem Item, int SubItem)
		{
			...
			subItemRect	= new Rectangle(subItemX, lviBounds.Top, this.Columns[order[i]].Width, lviBounds.Height -1);
      ...
      ec.Name = c.Name;
			...
			c.MouseClick += new System.Windows.Forms.MouseEventHandler(_embeddedControl_Click);
      this.Controls.Add(c);
		}
		...
		public void RemoveEmbeddedControl(string c)
		{
			if (c == null)
				throw new ArgumentNullException();
			...
			for (int i=0; i<_embeddedControls.Count; i++)
			{
				...
				if (ec.Control.Name == c)
				{
          ec.Control.MouseClick -= new MouseEventHandler(_embeddedControl_Click);
		...
		public Control GetEmbeddedControl(string strProName)
		{
			foreach (EmbeddedControl ec in _embeddedControls)
        if(ec.Name == strProName)
					return ec.Control;
      ...
      switch(m.Msg)
      {
        case WM_PAINT:
          ...
          foreach(EmbeddedControl ec in _embeddedControls)
          {
            ...
            ec.Control.Bounds = rc;     // Set embedded control's bounds
          }
          break;
      }
      base.WndProc(ref m);
    ...
    private void _embeddedControl_Click(object sender, MouseEventArgs e)
		{
